...
sim.data.sp <- readRDS(".../sp.sim.data.01.rds")
...
saveRDS(runPIMSeq1_A, ".../SPsimA/runPIMSeq1_A.rds")
...
saveRDS(runMAST_A, ".../SPsimA/runMAST_A.rds")
...
saveRDS(runSAMseq_A, ".../SPsimA/runSAMseq_A.rds")
...
sim.data.nb <- readRDS(".../nb.sim.data.01.rds")
...
saveRDS(runPIMSeq1_A, ".../NBsimA/runPIMSeq1_Ab.rds")
...
saveRDS(runSAMseq_A, ".../NBsimA/runSAMseq_A.rds")
...
saveRDS(runMAST_A, ".../NBsimA/runMAST_A.rds")
